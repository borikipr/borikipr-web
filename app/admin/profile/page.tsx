  ...
  return (
    <AdminPageShell>
      <div className="space-y-6">
        ...
        <ProfileForms displayName={admin.displayName} professionalTitle={admin.professionalTitle || ""} professionalRoles={admin.professionalRoles} professionalLicenseNumber={admin.professionalLicenseNumber || ""} profileImageUrl={admin.profileImageUrl || ""} email={admin.email || ""} username={admin.username} roleLabel={systemRoleLabels[access.systemRole]} professionalEmail={admin.professionalEmail || ""} professionalPhone={admin.professionalPhoneE164 || ""} whatsappEnabled={admin.professionalPhoneWhatsappEnabled} professionalBio={admin.professionalBio || ""} publicProfileEnabled={admin.publicProfileEnabled} publicProfileApprovalState={admin.publicProfileApprovalState} />
      </div>
    </AdminPageShell>
  );
}
