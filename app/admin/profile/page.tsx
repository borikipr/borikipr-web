  ...
  return (
    <AdminPageShell>
      <div className="space-y-6">
        <AdminPageHeader breadcrumbs={[{ href: "/admin", label: "Admin" }, { label: "Mi perfil" }]} eyebrow="Cuenta" title="Mi perfil" description="Administra únicamente tu información de acceso y recuperación." />
        ...
        <ProfileForms displayName={admin.displayName} email={admin.email || ""} username={admin.username} roleLabel="Administrador" />
      </div>
    </AdminPageShell>
  );
}
