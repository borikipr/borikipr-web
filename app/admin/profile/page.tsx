  ...
  return (
    <AdminPageShell>
      <div className="space-y-6">
        ...
        <ProfileForms displayName={admin.displayName} professionalTitle={admin.professionalTitle || ""} professionalRoles={admin.professionalRoles} professionalLicenseNumber={admin.professionalLicenseNumber || ""} profileImageUrl={admin.profileImageUrl || ""} email={admin.email || ""} username={admin.username} roleLabel="Administrador" />
      </div>
    </AdminPageShell>
  );
}
