...
export default function EditarPropiedadForm({
  ...
  const [origenListado, setOrigenListado] = useState(propiedad.origen_listado);
  const [permisoPublicar, setPermisoPublicar] = useState(propiedad.permiso_publicar_web);
  const [permisoFotos, setPermisoFotos] = useState(propiedad.permiso_usar_fotos);
