...
export default async function TeamMemberDetailPage({ params, searchParams }: { params: Promise<{ userId: string }>; searchParams: Promise<{ notice?: string }> }) {
  ...
  return (
    <AdminPageShell>
      ...
      <PublicProfileReview targetId={member.id} displayName={member.displayName} status={member.publicProfileApprovalState} isSelf={isSelf} />
