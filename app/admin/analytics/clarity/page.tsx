...
export default async function AdminClarityAnalyticsPage({
 ...
 const overviewMetrics: MetricCard[] = [
  {
   label: "Páginas populares",
   value: formatNumber(clarityData?.topPages.length),
   description: "URLs públicas con actividad agregada en Clarity.",
  },
  {
   label: "Dispositivos",
   value: formatNumber(clarityData?.devices.length),
   description: "Categorías de dispositivo disponibles.",
  },
  {
   label: "Fuentes",
  ...
  },
  {
   ...
   description: "Clics repetidos que pueden indicar frustración.",
  },
  {
   label: "Dead clicks",
  ...
  },
  {
   ...
   description: "Métrica agregada disponible desde Clarity.",
  },
  {
   label: "Engagement time",
   value: formatNumber(behaviorValue(behaviorEvents, "engagement_time")),
   description: "Tiempo de interacción agregado desde Clarity.",
  },
 ];
  ...
  return (
   <main className="px-4 py-8 md:px-6">
     ...
     <div className="surface-card p-6 md:p-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
       ...
       <p className="body-base mt-3 max-w-3xl">
        Detalle de páginas populares, dispositivos, fuentes y señales
       ...
       <p className="mt-3 text-sm font-semibold text-[#11518b]">
        ...
        los Últimos 3 días disponibles
       </p>
      </div>
    ...
    <AnalyticsRefreshControls
     ...
     mode="disabled"
     note="Clarity insights se actualiza aproximadamente cada 12 horas para proteger el límite de la API."
    />
    ...
    <div className="grid gap-5 lg:grid-cols-2 2xl:grid-cols-3">
     <AnalyticsChartCard
      eyebrow="Páginas populares"
      title="Páginas y URLs"
      description="Páginas públicas con actividad agregada por Clarity."
     >
      <AnalyticsHorizontalBarChart data={pageRows(clarityData?.topPages ?? [])} />
     </AnalyticsChartCard>

     <AnalyticsChartCard
      eyebrow="Señales de comportamiento"
      title="Señales de comportamiento"
      description="Rage clicks, dead clicks, quick backs, scroll y errores agregados."
     >
      <AnalyticsHorizontalBarChart
       data={behaviorRows(behaviorEvents)}
       emptyMessage="No hay señales de comportamiento disponibles para el rango seleccionado."
      />
     </AnalyticsChartCard>
     ...
     <AnalyticsChartCard
      ...
      title="Dispositivos"
      description="Categorías de dispositivo reportadas por Clarity."
     >
