...
export function GovernanceForms({drafts}:{drafts:{classifications:{id:string;label:string}[];consents:{id:string;label:string}[];privacy:{id:string;label:string}[];retention:{id:string;label:string;status:string}[]}}) {
