...
export function GovernanceForms({ drafts }: { drafts: Drafts }) {
  ...
  return <section className="signature-governance min-w-0 max-w-full space-y-6" aria-labelledby="governance-management">
    ...
    <section className="surface-card min-w-0 max-w-full overflow-hidden p-5" aria-labelledby="versiones-politicas"><h2 id="versiones-politicas" className="text-lg font-semibold">Versiones y políticas</h2><div className="mt-2 space-y-6"><p className="text-sm text-slate-600">Crea, revisa y aprueba versiones antes de que puedan usarse. Estas acciones conservan sus confirmaciones y controles de servidor.</p>
    ...
    <section className="surface-card min-w-0 max-w-full overflow-hidden border-amber-200 p-5" aria-labelledby="acciones-sensibles"><h2 id="acciones-sensibles" className="text-lg font-semibold text-amber-950">Acciones sensibles</h2><div className="mt-2 space-y-6"><p className="text-sm text-slate-600">Estas operaciones afectan autorizaciones, conservación o excepciones. Cada una conserva confirmaciones explícitas y autorización de servidor.</p>
